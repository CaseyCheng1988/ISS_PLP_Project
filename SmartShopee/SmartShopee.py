import requests, json, os, sys, spacy
from pathlib import Path

model_path = 'title_model'

class SmartShopee:

  def __init__(self):
    self.product_search_header = product_search_header = {'accept': '*/*',
  ...
  def get_competitors(self, title, prod_limit=50, rev_limit=50):
